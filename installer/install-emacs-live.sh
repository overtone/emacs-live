...
$HTTP_CLIENT $tmp_dir/intro.txt https://raw.github.com/jfosco/emacs-live/master/installer/intro.txt
$HTTP_CLIENT $tmp_dir/outro.txt https://raw.github.com/jfosco/emacs-live/master/installer/outro.txt
...
function download_tarball {
     ...
     echo ""
     $HTTP_CLIENT $tmp_dir/live.zip https://github.com/jfosco/emacs-live/zipball/master
...
function git_clone {
     ...
     echo ""
    git clone https://github.com/jfosco/emacs-live.git $tmp_dir/overtone-emacs-live
}
